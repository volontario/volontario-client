(function(ionic) {
  ...
  var SwipeableCardView = ionic.views.View.inherit({
    ...
    _doDrag: function(e) {
      ...
      this.scale = this.x > 0 ? 1+this.rotationAngle*1.5 : 1-this.rotationAngle*1.5;

      this.el.style.transform = this.el.style.webkitTransform = 'translate3d(' + this.x + 'px, ' + this.y  + 'px, 0) scale(' + (this.scale || 0) + ') rotate(' + (this.rotationAngle || 0) + 'rad)';
    ...
    return {
      ...
      controller: function($scope, $element) {
        ...
        this.partial = function(amt) {
          /*
          No need to move another clothes/cards
